         ...
         <div class="ed-container">
            ...
            <div id="primary">
                  ...
                  <?php
                     ...
                     $produk = $pdo->query("SELECT id_kategori,id_produk,judul,judul_seo,gambar,deskripsi,harga FROM produk  ORDER BY tgl DESC LIMIT $posisi,$batas");
                     $multidata2 = $pdo->query("SELECT id_produk FROM produk ORDER BY tgl DESC");
                  ...
                  ?>
                     <li class="post-723 product type-product status-publish has-post-thumbnail product_cat-produk-paket first instock shipping-taxable purchasable product-type-simple">
                        ...
                        <a href="kategori/<?php echo $tkatego["judul_seo"].'-'.$tkatego["id_kategori"]; ?>" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                  ...
                  $linkHalaman = $page->navHalaman($_GET['page'], $jmlhalaman, "produk");
