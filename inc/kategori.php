         ...
         <?php
         $onedatas = $pdo->query("SELECT * FROM kategori WHERE id_kategori='$_GET[id]'");
         ...
         <div class="ed-container">
            <nav class="woocommerce-breadcrumb">
               ...
               <a href="../kategori/<?php echo $tonedatas["judul_seo"].'-'.$tonedatas["id_kategori"]; ?>"><?php echo $tonedatas["judul"]; ?></a>
            </nav>
            <div id="primary">
                  ...
                  <?php
                     ...
                     $produk = $pdo->query("SELECT id_kategori,id_produk,judul,judul_seo,gambar,deskripsi,harga FROM produk WHERE id_kategori='$tonedatas[id_kategori]' ORDER BY tgl DESC LIMIT $posisi,$batas");
                     $multidata2 = $pdo->query("SELECT id_produk FROM produk WHERE id_kategori='$tonedatas[id_kategori]' ORDER BY tgl DESC");
                  ...
                  $linkHalaman = $page->navHalaman($_GET['page'], $jmlhalaman, "../kategori/$tonedatas[judul_seo]-$tonedatas[id_kategori]");
