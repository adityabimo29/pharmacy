...
if (empty($_SESSION['namaadmin']) AND empty($_SESSION['leveladmin'])){
				...
				<div class="col-md-12">
				  ...
				  <div class="box box-black">
					...
					<div class="box-body table-responsive">
						...
						<?php
						$no = 1;
						$tampil = $pdo->query("SELECT * FROM about ORDER BY id_about ASC");
						...
						?>
							<tr>
								...
								<td align="center">
									<a href="<?php echo $module; ?>-edit-<?php echo $r['id_about']; ?>" class="btn btn-success btnadmin" role="button" aria-pressed="true" style="width: 80px;margin-bottom: 5px;"><i class="fa fa-fw fa-edit"></i> Edit</a>
									
									<a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');" href="modul/<?php echo $module; ?>/aksi.php?module=<?php echo $module; ?>&act=remove&id=<?php echo $r['id_about']; ?>"  class="btn btn-danger btnadmin" role="button" aria-pressed="true" style="width: 90px;margin-bottom: 5px;"><i class="fa fa-fw fa-trash"></i> Delete</a>
								</td>
	...
	<?php
		break;
		case "edit":
		$edit = $pdo->query("SELECT * FROM about WHERE id_about='$_GET[id]'");
				...
				<div class="col-md-12">
				  ...
				  <div class="box box-black">
					...
					<form role="form" action="modul/<?php echo $module; ?>/aksi.php?module=<?php echo $module; ?>&act=update" method="POST" enctype="multipart/form-data" >
						<input type="hidden" name="id_about" value="<?php echo $tedit['id_about']; ?>">
