...
if (empty($_SESSION['namaadmin']) AND empty($_SESSION['leveladmin'])){
		...
		<div class="col-md-12">
		  ...
		  <div class="box box-black">
			<div class="box-header">
				...
				<button class="btn bg-gray margin" onclick="window.location.href='<?php echo $module; ?>-add';"><i class="fa fa-plus" aria-hidden="true"></i> Tambah Kategori</button>
			</div><!-- /.box-header -->
			...
			<div class="box-body table-responsive">
				...
				<?php
				$no = 1;
				$tampil = $pdo->query("SELECT * from kategori ORDER BY case when urutan=0 then 1 else 0 end, urutan");
				while($r = $tampil->fetch(PDO::FETCH_ASSOC)){
					$stmt = $pdo->query("SELECT id_produk FROM produk WHERE id_kategori='$r[id_kategori]' ");
					$rowc = $stmt->rowCount();
				?>
					<tr>
						<td align="center"><?php echo  $no; ?></td>
						<td><?php echo $r['judul']; ?></td>
						<td align="center"><img src="../images/<?php echo "kategori/$imgname1-$r[gambar]"; ?>" width="180px" alt=""></td>
						...
						<td align="center">
							<a href="<?php echo $module; ?>-edit-<?php echo $r['id_kategori']; ?>" class="btn btn-success btnadmin" role="button" aria-pressed="true" style="width: 100px;margin-bottom: 5px;" title="Edit kategori"><i class="fa fa-fw fa-edit"></i> Edit</a>
							
							<!--
							<a href="<?php echo $module; ?>-view-<?php echo $r['id_kategori']; ?>" class="btn btn-primary btnadmin" role="button" aria-pressed="true" style="width: 100px;margin-bottom: 5px;" title="View Detail kategori"><i class="fa fa-fw fa-sticky-note-o"></i> View</a>
							-->
							
							<?php if($r['hapus']!='No'){ ?>
							<a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');" href="modul/kategori/aksi.php?module=<?php echo $module; ?>&act=remove&id=<?php echo $r['id_kategori']; ?>"  class="btn btn-danger btnadmin" role="button" aria-pressed="true" style="width: 100px;margin-bottom: 5px;"><i class="fa fa-fw fa-trash"></i> Delete</a>
							<?php } ?>
	...
	<?php
		break;
		case "edit":
		$edit = $pdo->query("SELECT * FROM kategori WHERE id_kategori='$_GET[id]'");
				...
				<div class="col-md-12">
					<div class="box box-black">
						<div class="box-header">
							...
							<a href="<?php echo $module; ?>-edit-<?php echo $tedit['id_kategori']; ?>" type="button" class="btn btn-success" ><i class="fa fa-fw fa-edit"></i> Edit</a>
											...
											<div class="tab-pane fade active in" id="tit">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="photo">
															<p class="help-block"><a href="../images/<?php echo "kategori/$tedit[gambar]"; ?>" target="_blank"><img src="../images/<?php echo "kategori/small/$tedit[gambar]"; ?>" width="220px" alt=""></a></p>
														</div>
													</div>
												</div>
		...
		<section class="content">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box">
						<div class="box-header">
							<h1 style="text-transform: capitalize;">Semua Produk di Kategori <?php echo $tedit['judul']; ?></h1>
						</div>
						...
						<div class="box-body table-responsive">
							<table id="example1" class="table table-bordered table-striped">
								...
								<?php
								$no = 1;
								$tampil = $pdo->query("SELECT k.judul as jk,p.* FROM kategori k,produk p WHERE p.id_kategori=k.id_kategori AND p.id_kategori='$_GET[id]' ORDER BY p.tgl DESC");
								while($r = $tampil->fetch(PDO::FETCH_ASSOC)){
								?>
									<tr>
										<td align="center"><?php echo  $no; ?></td>
