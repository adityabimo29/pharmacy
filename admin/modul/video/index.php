...
if (empty($_SESSION['namaadmin']) AND empty($_SESSION['leveladmin'])){
				...
				<div class="col-md-12">
				  ...
				  <div class="box box-black">
					...
					<div class="box-body table-responsive">
						...
						<?php
						$no = 1;
						$tampil = $pdo->query("SELECT * FROM berita WHERE id_menu='7' ORDER BY id_berita DESC");
						while($r = $tampil->fetch(PDO::FETCH_ASSOC)){
						    if($r["gambar"]==""){$gbr="../noimages.jpg";}else{$gbr="small/$r[gambar]";}
						?>
							<tr>
								<td align="center"><?php echo  $no; ?></td>
								<td><?php echo  $r['judul']; ?></td>
								<td align="center"><div style="max-height:120px;overflow: hidden;"><a href="../images/<?php echo "berita/$gbr"; ?>" target="_blank"><img src="../images/<?php echo "berita/$gbr"; ?>" style="max-width: 150px;" alt=""></a></td>
								<td align="center"><?php echo  $r['status']; ?></td>
								<td align="center"><?php echo  tgl2($r['tgl']); ?></td>
								
								<td align="center">
									<a href="<?php echo $module; ?>-edit-<?php echo $r['id_berita']; ?>" class="btn btn-success btnadmin" role="button" aria-pressed="true" style="width: 80px;margin-bottom: 5px;"><i class="fa fa-fw fa-edit"></i> Edit</a>
									
									<a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');" href="modul/<?php echo $module; ?>/aksi.php?module=<?php echo $module; ?>&act=remove&id=<?php echo $r['id_berita']; ?>"  class="btn btn-danger btnadmin" role="button" aria-pressed="true" style="width: 90px;margin-bottom: 5px;"><i class="fa fa-fw fa-trash"></i> Delete</a>
								</td>
				...
				<div class="box-body table-responsive">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="status" class="form-control">
								...
								<option value="tranding topik">Tranding Topik</option>
							</select>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="col-md-12 nopadding">
							...
							<div class="form-group">
								<label for="exampleInputEmail1">Tanggal dan Waktu Posting</label>
						...
						<div class="form-group">
							<label for="exampleInputFile">URL Video Youtube</label>
							<input name="video" type="text" class="form-control">
							<p class="help-block">*) Contoh URL : <b>https://www.youtube.com/watch?v=ymOvZ6jDIok</b> atau <b>https://youtu.be/VTFa7mmnWLE</b></p>
						</div>
					</div>
	...
	<?php
		break;
		case "edit":
		$edit = $pdo->query("SELECT * FROM berita WHERE id_berita='$_GET[id]' AND id_menu='7'");
				...
				<div class="box-body table-responsive">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<select name="status" class="form-control">
								...
								<option value="tranding topik" <?php if($tedit['status']=='tranding topik'){echo "selected";} ?>>Tranding Topik</option>
							</select>
						</div>
						<div class="form-group">
							<label for="exampleInputFile">Gambar</label>
							<div class="photo">
								<p class="help-block"><a href="../images/<?php echo "berita/$tedit[gambar]"; ?>" target="_blank"><img src="../images/<?php echo "berita/small/$tedit[gambar]"; ?>" style="max-width:220px;" alt=""></a></p>
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							...
							<iframe width="400" height="200" src="https://www.youtube.com/embed/<?php echo $tedit['video']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
						
						</div><!-- /.box-body -->
						<div class="form-group">
							<label for="exampleInputFile">URL Video Youtube</label>
							<input name="video" type="text" class="form-control" value="https://www.youtube.com/watch?v=<?php echo $tedit['video']; ?>">
							<p class="help-block">*) Contoh URL : <b>https://www.youtube.com/watch?v=ymOvZ6jDIok</b> atau <b>https://youtu.be/VTFa7mmnWLE</b></p>
						</div>
					</div>
