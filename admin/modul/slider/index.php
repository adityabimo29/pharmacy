				...
				<div class="col-md-12">
				  ...
				  <div class="box box-black">
					<div class="box-header">
						...
						<button class="btn bg-gray" onclick="window.location.href='slider-add';"><i class="fa fa-plus" aria-hidden="true"></i> Add <?php echo $hal; ?></button>
					</div><!-- /.box-header -->
					...
					<div class="box-body table-responsive">
						...
						<?php
						$no = 1;
						$tampil = $pdo->query("SELECT * FROM slider ORDER BY case when urutan=0 then 1 else 0 end, urutan ASC");
						...
						?>
							<tr>
								...
								<td align="center">
									<a href="<?php echo $module; ?>-edit-<?php echo $r['id_slider']; ?>" class="btn btn-success btnadmin" role="button" aria-pressed="true" style="width: 80px;margin-bottom: 5px;"><i class="fa fa-fw fa-edit"></i> Edit</a>
									
									<a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');" href="modul/<?php echo $module; ?>/aksi.php?module=<?php echo $module; ?>&act=remove&id=<?php echo $r['id_slider']; ?>"  class="btn btn-danger btnadmin" role="button" aria-pressed="true" style="width: 80px;margin-bottom: 5px;"><i class="fa fa-fw fa-trash"></i> Delete</a>
								</td>
							</tr>
						<?php
						$no++;
				...
				<div class="box-body table-responsive">
					...
					<div class="col-md-12">
						<div class="form-group">
							<label for="exampleInputFile">Gambar <span title="wajib" style="color: red;">*</span></label>
							<div class="photo">
								<p class="help-block"><a href="../images/<?php echo "slider/$tedit[gambar]"; ?>" target="_blank"><img src="../images/<?php echo "slider/small/$tedit[gambar]"; ?>" width="220px"></a></p>
