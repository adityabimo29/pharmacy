		...
		<div class="col-md-12">
			<div class="box box-black">
				<div class="box-header">
					...
					<form role="form" action="modul/lap-penjualan/aksi.php?module=<?php echo $module; ?>&act=printLaporan"
					...
					<div class="row">
						...
						<button style='margin-left: 15px;margin-top:23px' type="submit" class="btn btn-success"><i class="fa fa-fw fa-save"></i> Download Laporan</button>
					</div>
			</form>
