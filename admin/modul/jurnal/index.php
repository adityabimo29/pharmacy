...
if (empty($_SESSION['namaadmin']) AND empty($_SESSION['leveladmin'])){
				...
				<div class="col-md-12">
				  ...
				  <div class="box box-black">
					...
					<div class="box-body table-responsive">
						...
						<?php
						$no = 1;
						$tampil = $pdo->query("SELECT * FROM jurnal ORDER BY tgl DESC");
						while($r = $tampil->fetch(PDO::FETCH_ASSOC)){
						?>
							<tr>
								<td align="center"><?php echo  $no; ?></td>
								<td><?php echo  $r['judul']; ?></td>
								<td align="center"><div style="max-height:120px;overflow: hidden;"><a href="../images/<?php echo "jurnal/$r[gambar]"; ?>" target="_blank"><img src="../images/<?php echo "jurnal/small/$r[gambar]"; ?>" style="max-width: 150px;" alt=""></a></td>
								<td align="center"><?php echo  $r['status']; ?></td>
								<td align="center"><?php echo  tgl2($r['tgl']); ?></td>
								
								<td align="center">
									<a href="<?php echo $module; ?>-edit-<?php echo $r['id_jurnal']; ?>" class="btn btn-success btnadmin" role="button" aria-pressed="true" style="width: 80px;margin-bottom: 5px;"><i class="fa fa-fw fa-edit"></i> Edit</a>
									
									<a onClick="javascript: return confirm('Data yang Sudah di Hapus TIDAK BISA Dikembalikan Kembali. Apakah Anda yakin ingin Menghapus Data Ini!!');" href="modul/<?php echo $module; ?>/aksi.php?module=<?php echo $module; ?>&act=remove&id=<?php echo $r['id_jurnal']; ?>"  class="btn btn-danger btnadmin" role="button" aria-pressed="true" style="width: 90px;margin-bottom: 5px;"><i class="fa fa-fw fa-trash"></i> Delete</a>
								</td>
	...
	break;
	case "edit":
	$edit = $pdo->query("SELECT * FROM jurnal WHERE id_jurnal='$_GET[id]'");
	...
	<section class="content">
		  ...
		  <div class="box box-black">
			...
			<form role="form" action="modul/<?php echo $module; ?>/aksi.php?module=<?php echo $module; ?>&act=update" method="POST" enctype="multipart/form-data" >
				<input type="hidden" name="id_jurnal" value="<?php echo $tedit['id_jurnal']; ?>">
