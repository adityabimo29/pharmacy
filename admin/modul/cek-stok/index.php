		...
		<div class="col-md-12">
			<div class="box box-black">
				<div class="box-header">
					<h1 style="text-transform: capitalize;">CEK STOK</h1>
					<ol class="breadcrumb">
						<li><a href="media.php?module=home"><i class="fa fa-dashboard"></i> Home</a></li>
						<li class="active">Cek Stok</li>
					</ol>
					<!-- <div class="row">
						<div class="col-md-6">
				...
				<div class="row">
					...
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h3 class="panel-title">Info Stok Obat</h3>
						</div>
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		// )
		<?php
		if(!isset($_SESSION['pembelian2']) || $_SESSION['pembelian2'] == null){
		$z = array();
