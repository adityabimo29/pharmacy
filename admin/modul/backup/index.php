...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<div class="box box-black">
				<div class="box-header">
					<h1 style="text-transform: capitalize;">Backup Data</h1>
					<ol class="breadcrumb">
						<li><a href="media.php?module=home"><i class="fa fa-dashboard"></i> Home</a></li>
				...
				<div class="row">
					<div class="col-md-3 col-md-offset-3">
						<form role="form" action="modul/backup/aksi.php?module=backup&act=downloadDistributor"
					method="POST" enctype="multipart/form-data">
				<button class="btn btn-success margin btn-lg"
						type='submit'><i class="fa fa-file-excel-o"
							aria-hidden="true"></i> Download Data Distributor</button>
				</form>
					</div>
					<div class="col-md-3">
						<form role="form" action="modul/backup/aksi.php?module=backup&act=downloadObat"
					method="POST" enctype="multipart/form-data">
				<button class="btn btn-primary margin btn-lg"
						type='submit'><i class="fa fa-file-excel-o"
							aria-hidden="true"></i> Download Data Obat</button>
				</form>
					</div>
				</div>
