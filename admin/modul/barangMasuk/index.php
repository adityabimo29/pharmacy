						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleInputEmail1">Harga Beli (Satuan) <span title="wajib"
										style="color: red;">*</span></label>
								<input name="harga_beli" type="number" class="form-control uang" placeholder='1000' required>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleInputEmail1">Harga Diskon </span></label>
								<input name="harga_diskon" type="number" class="form-control uang" placeholder="500">
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group">
						...
						<div class="col-md-6">
							<div class="form-group">
								<label for="exampleInputEmail1">Harga Jual <span title="wajib"
										style="color: red;">*</span></label>
								<input name="harga_jual" type="number" class="form-control uang" placeholder="1500" required>
							</div>
						</div>
					</div>
