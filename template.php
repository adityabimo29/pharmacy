...
?>
<body class="home page-template page-template-tpl-home page-template-tpl-home-php page page-id-264 wp-custom-logo woocommerce-js fullwidth">
<?php
} 
?>
